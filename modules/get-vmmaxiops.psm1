...
Process { 
       if ($_.PowerState -eq "PoweredOn") {
            ...
            $VMMetrics = "virtualdisk.numberwriteaveraged.average","virtualdisk.numberreadaveraged.average","virtualdisk.write.average","virtualdisk.read.average"
       ...
       $reportPerf | Select-Object VM, Disk, CapacityGB, IOPSWriteAvg, IOPSReadAvg, KBWriteAvg, KBReadAvg
    }
