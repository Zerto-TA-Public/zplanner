...
$csvPath = "/home/zerto/data/stats8.csv"
$vmlist = "/home/zerto/data/vmlist8.csv"
...
/usr/bin/php /home/zerto/zplanner/loaders/loadmysql.php stats8.csv
...
$file = "/home/zerto/logs/" + $now + "-getio8.log"
