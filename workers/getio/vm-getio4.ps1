...
$csvPath = "/home/zerto/data/stats4.csv"
$vmlist = "/home/zerto/data/vmlist4.csv"
...
/usr/bin/php /home/zerto/zplanner/loaders/loadmysql.php stats4.csv
...
$file = "/home/zerto/logs/" + $now + "-getio4.log"
