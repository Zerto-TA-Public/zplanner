...
$csvPath = "/home/zerto/data/stats2.csv"
$vmlist = "/home/zerto/data/vmlist2.csv"
...
/usr/bin/php /home/zerto/zplanner/loaders/loadmysql.php stats2.csv
...
$file = "/home/zerto/logs/" + $now + "-getio2.log"
