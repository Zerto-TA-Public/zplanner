...
$csvPath = "/home/zerto/data/stats7.csv"
$vmlist = "/home/zerto/data/vmlist7.csv"
...
/usr/bin/php /home/zerto/zplanner/loaders/loadmysql.php stats7.csv
...
$file = "/home/zerto/logs/" + $now + "-getio7.log"
