...
$csvPath = "/home/zerto/data/stats0.csv"
$vmlist = "/home/zerto/data/vmlist0.csv"
...
/usr/bin/php /home/zerto/zplanner/loaders/loadmysql.php stats0.csv
...
$file = "/home/zerto/logs/" + $now + "-getio0.log"
