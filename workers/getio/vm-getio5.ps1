...
$csvPath = "/home/zerto/data/stats5.csv"
$vmlist = "/home/zerto/data/vmlist5.csv"
...
/usr/bin/php /home/zerto/zplanner/loaders/loadmysql.php stats5.csv
...
$file = "/home/zerto/logs/" + $now + "-getio5.log"
