...
$csvPath = "/home/zerto/data/stats9.csv"
$vmlist = "/home/zerto/data/vmlist9.csv"
...
/usr/bin/php /home/zerto/zplanner/loaders/loadmysql.php stats9.csv
...
$file = "/home/zerto/logs/" + $now + "-getio9.log"
