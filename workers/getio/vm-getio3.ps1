...
$csvPath = "/home/zerto/data/stats3.csv"
$vmlist = "/home/zerto/data/vmlist3.csv"
...
/usr/bin/php /home/zerto/zplanner/loaders/loadmysql.php stats3.csv
...
$file = "/home/zerto/logs/" + $now + "-getio3.log"
